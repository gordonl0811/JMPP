...
import static tech.gordonlee.jmpp.components.utils.TestUtils.SINGLE_PACKET_PCAP;
import static tech.gordonlee.jmpp.components.utils.TestUtils.SINGLE_PACKET_PCAP_COUNT;
...
public class IpAddressRewriterTest {
    ...
    public void testRewritesAddressesCorrectly() throws IOException, InterruptedException {
        ...
        Disruptor<PacketEvent> rewriterDisruptor = new Disruptor<>(PacketEvent::new, SINGLE_PACKET_PCAP_COUNT, DaemonThreadFactory.INSTANCE, ProducerType.SINGLE, new BusySpinWaitStrategy());
